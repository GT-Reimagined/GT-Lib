...
public class GTGuiTextures {
    ...
    public static final UITexture REDSTONE = UITexture.fullImage(new ResourceLocation("textures/item/redstone.png"), null);
    public static final UITexture EXPORT = UITexture.fullImage(Ref.ID,"textures/gui/button/export", null);
    public static final UITexture IMPORT =  UITexture.fullImage(Ref.ID,"textures/gui/button/import", null);
    public static final UITexture EXPORT_IMPORT =  UITexture.fullImage(Ref.ID,"textures/gui/button/export_import", null);
    public static final UITexture IMPORT_EXPORT =  UITexture.fullImage(Ref.ID,"textures/gui/button/import_export", null);
    public static final UITexture INPUT_OFF =  UITexture.fullImage(Ref.ID,"textures/gui/button/input_off", null);

    public static final UITexture GREY_OFF =  UITexture.fullImage(Ref.ID,"textures/gui/button/grey_off.png",  null);
    public static final UITexture GREY_ON =  UITexture.fullImage(Ref.ID,"textures/gui/button/grey_on.png",  null);
    public static final UITexture BLUE_OFF =  UITexture.fullImage(Ref.ID,"textures/gui/button/blue_off.png",  null);
    public static final UITexture BLUE_ON =  UITexture.fullImage(Ref.ID,"textures/gui/button/blue_on.png",  null);
    public static final UITexture LESS =  UITexture.fullImage(Ref.ID,"textures/gui/button/less.png", null);
    public static final UITexture EQUAL =  UITexture.fullImage(Ref.ID,"textures/gui/button/equal.png", null);
    public static final UITexture MORE =  UITexture.fullImage(Ref.ID,"textures/gui/button/more.png", null);
    public static final UITexture WHITELIST =  UITexture.fullImage(Ref.ID,"textures/gui/button/whitelist.png", null);
    public static final UITexture BLACKLIST =  UITexture.fullImage(Ref.ID,"textures/gui/button/blacklist.png", null);
    public static final UITexture MINUS =  UITexture.fullImage(Ref.ID,"textures/gui/button/minus.png",  null);
    public static final UITexture PLUS =  UITexture.fullImage(Ref.ID,"textures/gui/button/plus.png",  null);
    public static final UITexture DIVISION =  UITexture.fullImage(Ref.ID,"textures/gui/button/division.png",  null);
    public static final UITexture MULT =  UITexture.fullImage(Ref.ID,"textures/gui/button/mult.png",  null);
    public static final UITexture PERCENT =  UITexture.fullImage(Ref.ID,"textures/gui/button/percent.png",  null);
    public static final UITexture ARROW_LEFT =  UITexture.fullImage(Ref.ID,"textures/gui/button/arrow_left.png", null);
    public static final UITexture A_LEFT =  UITexture.fullImage(Ref.ID,"textures/gui/button/a_left.png",  null);
    public static final UITexture A_RIGHT =  UITexture.fullImage(Ref.ID,"textures/gui/button/a_right.png",  null);
    public static final UITexture ARROW_RIGHT =  UITexture.fullImage(Ref.ID,"textures/gui/button/arrow_right.png",  null);
    public static final UITexture INPUT_OUTPUT =  UITexture.fullImage(Ref.ID,"textures/gui/button/in_out.png",  null);
