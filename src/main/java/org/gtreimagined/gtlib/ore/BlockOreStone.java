...
public class BlockOreStone extends BlockMaterialType implements ISharedAntimatterObject {
    ...
    public BlockOreStone(String domain, Material material) {
        super(domain, material, GTMaterialTypes.ORE_STONE, Properties.of(net.minecraft.world.level.material.Material.STONE).strength(1.5f, 3.0f).requiresCorrectToolForDrops());
