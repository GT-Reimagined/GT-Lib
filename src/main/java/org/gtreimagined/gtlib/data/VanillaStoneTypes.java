...
public class VanillaStoneTypes {
    ...
    public static StoneType BASALT = GTAPI.register(StoneType.class, new VanillaStoneType(Ref.ID, "basalt", GTLibMaterials.Basalt, "block/stone/", new Texture("minecraft", "block/basalt_side"), SoundType.BASALT, false).setState(Blocks.BASALT).setHardnessAndResistance(1.25F, 4.2F)
